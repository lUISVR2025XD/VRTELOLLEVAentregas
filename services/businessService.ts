...
const MOCK_BUSINESSES: Business[] = [
    ...
    { id: 'b3', name: 'Pizza Bella', category: 'Italiana', rating: 4.9, rating_count: 213, delivery_time: '20-30 min', fixed_delivery_fee: 35.50, image: 'https://picsum.photos/seed/pizza/400/300', location: { lat: 19.4290, lng: -99.1350 }, is_open: true, phone: '55-5555-5555', address: 'Plaza Central 1, Condesa, CDMX', email: 'pizza@negocio.com', opening_hours: 'L-V: 11:00 - 21:00', current_load: BusinessLoad.NORMAL, documents: [], approvalStatus: 'approved', isActive: true },
